...
@translate_help("csm-data.commands.storage.adx_send_scenariodata.description")
@click.option(
    "--dataset-absolute-path",
    envvar="CSM_DATASET_ABSOLUTE_PATH",
    show_envvar=True,
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.dataset_absolute_path"),
    metavar="PATH",
    required=True,
)
@click.option(
    ...
    metavar="PATH",
    show_envvar=True,
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.parameters_absolute_path"),
    required=True,
)
@click.option(
    "--simulation-id",
    ...
    required=True,
    metavar="UUID",
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.simulation_id"),
)
@click.option(
    "--adx-uri",
    ...
    required=True,
    metavar="URI",
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.adx_uri"),
)
@click.option(
    "--adx-ingest-uri",
    ...
    required=True,
    metavar="URI",
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.adx_ingest_uri"),
)
@click.option(
    "--database-name",
    ...
    required=True,
    metavar="NAME",
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.database_name"),
)
@click.option(
    ...
    default=False,
    show_default=True,
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.send_parameters"),
)
@click.option(
    ...
    default=False,
    show_default=True,
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.send_datasets"),
)
@click.option(
    "--wait/--no-wait",
    ...
    default=False,
    show_default=True,
    help=T("csm-data.commands.storage.adx_send_scenariodata.parameters.wait"),
)
