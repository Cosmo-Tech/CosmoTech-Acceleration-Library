...
class TestTwinDataLayerEdgeCases:
    ...
    def test_process_csv_file_with_errors(self, mock_logger, mock_post):
        ...
        with patch("builtins.open", mock_open(read_data=csv_content)):
            ...
            mock_logger.error.assert_any_call(T("coal.services.azure_storage.import_errors").format(count=2))
            mock_logger.error.assert_any_call(T("coal.services.azure_storage.error_detail").format(error="Error 1"))
            mock_logger.error.assert_any_call(T("coal.services.azure_storage.error_detail").format(error="Error 2"))
