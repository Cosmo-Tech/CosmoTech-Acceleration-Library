...
class TestRunnerApi:
    ...
    def test_runner_api_initialization(self, mock_cosmotech_config, mock_api_client):
        ...
        api = RunnerApi(configuration=mock_config)
    ...
    @patch("cosmotech_api.ApiClient")
    @patch("cosmotech_api.Configuration")
    def test_get_runner_metadata(self, mock_cosmotech_config, mock_api_client):
        ...
        result = api.get_runner_metadata("org-123", "ws-456", "runner-789")
    ...
    @patch("cosmotech_api.ApiClient")
    @patch("cosmotech_api.Configuration")
    def test_get_runner_metadata_with_include(self, mock_cosmotech_config, mock_api_client):
        ...
        result = api.get_runner_metadata("org-123", "ws-456", "runner-789", include=["id", "name"])
    ...
    @patch("cosmotech_api.ApiClient")
    @patch("cosmotech_api.Configuration")
    def test_get_runner_metadata_with_exclude(self, mock_cosmotech_config, mock_api_client):
        ...
        result = api.get_runner_metadata("org-123", "ws-456", "runner-789", exclude=["description"])
    ...
    def test_download_runner_data_with_parameters(self, mock_parameters_class, mock_cosmotech_config, mock_api_client):
        ...
        api.download_runner_data("org-123", "ws-456", "runner-789", "/tmp/params")
    ...
    @patch("cosmotech_api.ApiClient")
    @patch("cosmotech_api.Configuration")
    def test_download_runner_data_no_parameters(self, mock_cosmotech_config, mock_api_client):
    ...
    def test_download_runner_data_with_datasets(self, mock_dataset_api_class, mock_cosmotech_config, mock_api_client):
        ...
        api.download_runner_data("org-123", "ws-456", "runner-789", "/tmp/params", "/tmp/datasets")

        api.get_runner.assert_called_once_with("org-123", "ws-456", "runner-789")
        mock_dataset_api_class.assert_called_once_with(mock_config)
    ...
    @patch("cosmotech_api.ApiClient")
    @patch("cosmotech_api.Configuration")
    def test_download_runner_data_no_datasets_without_folder(self, mock_cosmotech_config, mock_api_client):
        ...
        api.download_runner_data("org-123", "ws-456", "runner-789", "/tmp/params", dataset_folder=None)
