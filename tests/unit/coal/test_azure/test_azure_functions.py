...
class TestFunctionsFunctions:
    ...
    def test_generate_main_success(self):
        ...
        # Mock the download_run_data function
        ...
        with patch("cosmotech.coal.azure.functions.download_run_data", return_value=mock_download_result), patch(
    ...
    def test_generate_main_with_parallel_false(self):
        ...
        with patch(
            "cosmotech.coal.azure.functions.download_run_data", return_value=mock_download_result
            ...
            # Assert
            # Verify that download_run_data was called with parallel=False
